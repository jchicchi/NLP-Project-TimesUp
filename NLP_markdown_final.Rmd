...
Here, it is possible to visually determine the best value for K. Along the line chart, there appears to be a strong inflection point at K=9, therefore it looks like K = 9 is a reasonable choice for our optimal number of clusters. 
```{r}
set.seed(42)
